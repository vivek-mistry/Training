            ...
            <form action="{{ route('product_update', ['id' => $product->id]) }}" method="POST" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <input type="checkbox" name="product_color[]" value="Red"
                        {{ in_array('Red', $product_color) ? 'checked' : '' }}> Red
                    <input type="checkbox" name="product_color[]" value="Blue"
                        {{ in_array('Blue', $product_color) ? 'checked' : '' }}> Blue
                    <input type="checkbox" name="product_color[]" value="Green"
                        {{ in_array('Green', $product_color) ? 'checked' : '' }}> Green
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="checkbox" name="status" value="1" {{ $product->status == true ? 'checked' : '' }}>
                    Status
                </div>
